...
> **💡 Tip**: Start with Hypothesis A (High likelihood, Low effort). Refer to `/root/.trae/builtin_skills/TRAE-debugger/guides/scenarios.md` for scenario-specific hypothesis templates.
