...
- one specific observation from a source (a concrete trigger like hiring or expansion);
- one plausible pain hypothesis (linked to the salon's daily reality);
- one relevant bridge to the partner offer;
- one simple ask (low-friction call to action);
...
(Cite the real trigger signal: e.g. "Saw your active recruitment for colorists" or "Impressed by your focus on balayage")

## Human reviewer notes
(Note any specific compliance or tone warnings)
...
4. Forgetting to link Review Queue items to CRM. Fix: after a manual review approval, the corresponding lead in CRM must be updated to 'approved' and the draft linked or path recorded.
